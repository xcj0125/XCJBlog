...
const SITE_TIMEZONE = -3; //设置你的网站时区 from -12 to 12 default in UTC+8
export const siteConfig: SiteConfig = {
	title: "Mizuki",
	subtitle: "One demo website",
	siteURL: "https://xcj-blog.vercel.app/", // 请替换为你的站点URL，以斜杠结尾
	...
	banner: {
		...
		homeText: {
			...
			subtitle: [
				"愿你我都能找到一个容身之处",
				"世界很大,你也一样",
				"有些路,只能一个人走;而有些风景,注定要一个人看",
				"即使世界再喧嚣,也要在心底保留一片宁静",
				"有些人走着走着就散了,而有些事看着看着就淡了",
			],
			typewriter: {
